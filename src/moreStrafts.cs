...
{
    [BepInPlugin("com.nitrogenia.morestrafts", "More Strafts Players (Isaac Test)", "0.0.3")]
    public class moreStraftsMod : BaseUnityPlugin
    {
        void Awake()
        {
            ...
            Logger.LogInfo("More Strafts Mod alpha v0.0.3 by Nitrogenia ISAAC TEST loaded! Max players extended to 10.");
        }
    }
